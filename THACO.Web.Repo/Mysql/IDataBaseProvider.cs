...
namespace THACO.Web.Repo.Mysql
{
    public interface IDataBaseProvider
    {
        ...
        Task<object> ExcuteScalarTextAsync(IDbTransaction transaction, string commandText, object param);
        ...
        /// <param name="param">Tham số</param>
        /// <returns></returns>
        Task<int> ExecuteNoneQueryTextAsync(IDbTransaction cnn, string commandText, object param);
    }
}